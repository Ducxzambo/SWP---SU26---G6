...
<head>
    ...
    <title>Inpatient Detail — Veterinarian</title>
    <link rel="stylesheet"
...
<div class="container mt-4" style="max-width:800px">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">🏥 Inpatient Detail — Veterinarian</h4>
    ...
    <c:if test="${not empty admission}">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header fw-semibold">
                ...
                <c:if test="${not todayDone}">
                    <span class="badge bg-warning">No assessment today</span>
                </c:if>
            </div>
        ...
        <div class="d-flex gap-2">
            <c:if test="${admission.status ne 'Discharged' and not todayDone}">
                <a href="${pageContext.request.contextPath}/inpatient/assessment?admissionId=${admission.admissionID}"
                   class="btn btn-info btn-sm">
                    + Add Daily Assessment
                </a>
            </c:if>
